...
func TestParseStartArgsAndSupervisorSelection(t *testing.T) {
	tests := []struct {
		...
		{name: "supervisor agy default compact", args: []string{"--supervisor", "agy"}, wantPath: ".", wantMode: sidebarModeCompact, wantSupervisor: "agy"},
		{name: "supervisor agy equal with path", args: []string{"--supervisor=agy", "/tmp/project"}, wantPath: "/tmp/project", wantMode: sidebarModeCompact, wantSupervisor: "agy"},
		{name: "supervisor agy with supervisor-model split", args: []string{"--supervisor", "agy", "--supervisor-model", "gemini-2.5-pro"}, wantPath: ".", wantMode: sidebarModeCompact, wantSupervisor: "agy", wantSupervisorModel: "gemini-2.5-pro"},
		{name: "supervisor agy with supervisor-model equal", args: []string{"--supervisor=agy", "--supervisor-model=gemini-2.5-pro"}, wantPath: ".", wantMode: sidebarModeCompact, wantSupervisor: "agy", wantSupervisorModel: "gemini-2.5-pro"},
